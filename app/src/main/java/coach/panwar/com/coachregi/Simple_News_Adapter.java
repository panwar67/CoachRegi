 ...
 */
public class Simple_News_Adapter extends BaseAdapter {
    ...
    public Simple_News_Adapter(Context context, ArrayList<HashMap<String,String>> result )
    {
        cont = context;
        data = result;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      View rowView = inflater.inflate(R.layout.newslistitem, null);
        ...
        title.setText("TITLE : "+data.get(i).get("title"));
